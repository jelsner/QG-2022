...
-   Wilcoxon (Mann-Whitney U) non-parametric test for difference in population means
...
## Test for equal variance {.unnumbered}
...
## Wilcoxon (Mann-Whitney U) non-parameteric test for difference in population means {.unnumbered}
