...
## One-sample test of the population mean {.unnumbered}
...
## Two-sample test for the difference in population means {.unnumbered}
...
## Test of equal variance {.unnumbered}
...
## Wilcoxon (Mann-Whitney U) non-parameteric test of difference in means {.unnumbered}
