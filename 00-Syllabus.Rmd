...
1.  Reading and running the code in the lesson R markdown files (`.Rmd`) files. You can do this during the lessons as I talk and run the code or you can work through the file outside of class on your own.
