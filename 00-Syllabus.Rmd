...
This course is an introduction to the quantitative analysis of geographic data (data science for geographers). The course content is available on GitHub <https://github.com/jelsner/QG-2022>
...
-   All course materials are available through GitHub
...
During each lesson I will work through and explain the R code contained within an `xx-Lesson.Rmd` file in this classroom (BEL 320). The lesson files are comprehensive, so you can work through them on your own if you can't make it to class on a particular day.
...
Email the finished assignment file to [jelsner\@fsu.edu](mailto:jelsner@fsu.edu){.email}
