...
More simply you could say that you plot `Temp` on the x axis and `Ozone` on the y axis. But you want to acknowledge that the axes are aesthetics (there are others like color, size, etc).
