...
You need to know two things: (1) where the data are located, and (2) what type of data file is it.

Consider the file `US.txt` located in your project folder. It is in the `data` directory. Click on the file name. It opens a file tab displaying the contents.
...
The `here()` function from the {here} package locates the file relative to your project root.

You put the names of the directory and file in quotes.
...
Creating structured data files: <https://environmentalcomputing.net/getting-started-with-r/>
...
The pipe operator allows you to string together functions while keeping the code readable. You want your code to be machine readable (correct syntax) but also human readable.
