...
Once data are stored as an object, you use functions on the objects to summarize, analyze, or model the data values. Some common functions applied to data objects include
```{r}
sum(counts)
length(counts)
