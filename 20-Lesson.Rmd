...
Consider the following data set containing city pollution levels. The data are in the file _pollute.txt_. The data set contains levels of pollution in 41 cities along with explanatory variables including average temperature, the amount of industry, the population, the average wind speed, the amount of rain, and the number of wet days.
```{r}
