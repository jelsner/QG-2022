...
The goal is to make you aware of this alternative approach to quantitative geography.

## Distributions as Lego bricks {.unnumbered}

You need first to understand the concept of a distribution and be familiar with common distribution types.
...
Combining the prior with data results in the posterior. 
